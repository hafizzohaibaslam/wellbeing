      ...
      <div className='  max-w-[93%] xl:max-w-[83%] mx-auto pt-[116px] pb-[88px]'>
        <div className='grid lg:grid-cols-2 gap-[30px] '>
          ...
          <div className='text-white self-stretch '>
            ...
            <p className=' leading-[50px] xl:leading-[66px] text-[2.8rem] xl:text-[3.5rem] font-normal mb-[10px]'>Empowering Businesses to Thrive</p>
            ...
            <button className='px-[32px] flex items-center gap-2 py-[17px] mt-[38px] bg-customPink rounded-[10px]'><span>Get Free Consultation</span> 
        ...
        <div className='md:grid-cols-2 grid gap-[28px] xl:gap-[32px] mt-[88px]'>
          <div className='text-lightGray bg-center bg-cover p-[16px] md:p-[32px]'
          ...
          >
           ...
           <p className=' text-[20px] xl:text-[24px] leading-[34px] md:leading-[38px] font-normal pt-4'>To be the leading partner for businesses seeking innovative, sustainable, and human-centered solutions that drive long-term success and well-being.</p>
          ...
          >
           ...
           <p className=' text-[20px] xl:text-[24px] leading-[34px] md:leading-[38px] font-normal pt-4'>To provide businesses with personalized digital strategies that foster growth, resilience, and agility, enabling them to thrive in a dynamic environment.</p>
          
          </div>
        </div>
        <div className='text-lightGray bg-center  bg-no-repeat bg-contain bg-[#0C1C27] mt-[24px] p-[16px] md:p-[32px]'
           style={{ backgroundImage: "url('/assets/WhyUs/f3.png')" }}
          >
           <p className='text-[24px]'>OUR</p>
           <p className='text-customPink text-[48px] leading-[58px] font-normal'>VALUES</p>
           <p className=' text-[20px] xl:text-[24px] leading-[34px] md:leading-[38px] font-normal pt-4'>To driving excellence through cutting-edge innovation, maintaining the highest ethical standards, and always prioritizing the well-being of our clients and their communities.</p>
