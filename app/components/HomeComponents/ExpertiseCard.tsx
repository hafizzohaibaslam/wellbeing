...
const ExpertiseCard: React.FC<ExpertiseCardProps> = ({ mainTitle, description,img,index }) => {
  return (
    <div className=''>
      <div className={`relative  max-w-[360px] ${(index==1||index==3)?' md:mt-28':''}  overflow-y-hidden cursor-pointer border-b-[5px] hover:border-customPink border-white text-white group`}>
        ...
        <div className="absolute z-20 bottom-0 pl-[23px] pr-[10px] mb-[-60px] group-hover:mb-[35px] transition-all duration-700 ease-in-out">
          ...
          <p className="text-[40px] w-full leading-[50px] pb-[35px] group-hover:pb-0 transition-all duration-700 ease-in-out">
            {mainTitle}
          </p>
