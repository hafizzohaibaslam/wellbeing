        ...
        <div className='bg-primary'>
            ...
            <div className=' max-w-[93%] xl:max-w-[83%] mx-auto py-[120px]'>
                <div className='flex flex-col justify-center items-center'>
                    <p className='text-customPink text-[24px] leading-[34px] text-center'>OUR BLOGS</p>
                    <p className=' text-[2.5rem] md:text-[3.5rem] leading-[55px] md:leading-[66px] font-semibold text-center text-white '>Explore our blogs and reports</p>
                    <p className='text-[18px] leading-[30px] text-center mt-[16px] text-[#EBEBEB]'>Stay ahead with the latest trends, tips, and insights on digital solutions and mental health innovation.</p>
                </div>
